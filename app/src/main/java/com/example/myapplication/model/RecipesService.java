...
import com.example.myapplication.api.MarthaQueue;
import com.example.myapplication.api.MarthaRequest;
...
public class RecipesService {
    ...
    public void getAll(int userId, RecipesFetchListener listener, Context context) {
    ...
    public void add(String category, String name, int hours, int minutes, String description, int userId, RecipeRequestListener listener, Context context) {
